...
class PromotionsView extends Component {
    ...
    componentDidMount() {
        // in real time calling this api
        // new UserService().getPromotions((response) => {
        //     this.setState({promotions: response});
        // })
        this.setState({promotions: new UserService().getPromotions()});
    }
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHeaderColumn>From(reward)</TableHeaderColumn>
                                <TableHeaderColumn>To(reward)</TableHeaderColumn>
